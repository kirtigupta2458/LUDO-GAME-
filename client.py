...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/2 - 88, y=screen_height/2 -160)
...
def gameWindow():
    ...
    # Add Text
    canvas2.create_text( screen_width/2, screen_height/6, text = "Ludo Ladder", font=("Chalkboard SE",100), fill="white")
    ...
    resetButton =  Button(gameWindow,text="Reset Game", fg='black', font=("Chalkboard SE", 15), bg="grey",command=restGame, width=10, height=3)
    ...
    rollButton = Button(gameWindow,text="Roll Dice", fg='black', font=("Chalkboard SE", 15), bg="grey",command=rollDice, width=10, height=3)
    ...
    if(playerType == 'player1' and playerTurn):
        rollButton.place(x=screen_width / 2 - 50, y=screen_height/2  + 270)
    else:
        rollButton.pack_forget()

    # Creating Dice with value 1
    dice = canvas2.create_text(screen_width/2 + 10, screen_height/2 + 150, text = "\u2680", font=("Chalkboard SE",250), fill="white")
...
def handleWin(message):
    ...
    resetButton.place(x=screen_width / 2 - 50, y=screen_height - 270)
